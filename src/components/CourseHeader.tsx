...
export default function CourseHeader({ avgRating }: Props) {
  ...
  return (
    <section className="bg-white rounded-3xl p-10 border border-gray-100 shadow-[0_4px_25px_-5px_rgba(0,0,0,0.08)] w-full max-w-5xl mx-auto hover:shadow-[0_8px_35px_-5px_rgba(0,0,0,0.12)] transition-all">
      <div className="flex flex-col mb-8 sm:flex-row sm:items-center">
        ...
        <div className="flex items-center ml-10 mt-6 sm:mt-0 space-x-3">
