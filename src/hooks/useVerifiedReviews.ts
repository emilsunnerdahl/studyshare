...
async function addVerifiedReview(review_id: string, queryClient: ReturnType<typeof useQueryClient>): Promise<void> {
...
export function getAddVerifiedReviewFn(queryClient: ReturnType<typeof useQueryClient>) {
